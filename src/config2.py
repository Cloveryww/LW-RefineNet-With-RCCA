...
TRAIN_DIR = '/home/xiejinluo/data/PASCAL_VOC/VOCdevkit/VOC2012/'
VAL_DIR = TRAIN_DIR
#TRAIN_LIST = ['./data/train.nyu'] * 3
#VAL_LIST = ['./data/val.nyu'] * 3
TRAIN_LIST = ['/home/xiejinluo/data/PASCAL_VOC/VOCdevkit/VOC2012/ImageSets/Segmentation/train2.txt'] * 3
VAL_LIST = ['/home/xiejinluo/data/PASCAL_VOC/VOCdevkit/VOC2012/ImageSets/Segmentation/val2.txt'] * 3
SHORTER_SIDE = [350] * 3
CROP_SIZE = [500] * 3
...
RANDOM_SEED = 42
SNAPSHOT_DIR = './ckpt2/'
CKPT_PATH = './ckpt2/checkpoint.pth.tar'
